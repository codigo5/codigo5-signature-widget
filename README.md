...
| `theme`        | Theme identifier                       | enum, string, number | ``` cod5.signatureWidget.SignatureTheme.dark cod5.signatureWidget.SignatureTheme.light 'dark' 'light' 0 // dark 1 // light ``` | `'light'`                                                          |
